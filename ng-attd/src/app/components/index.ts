...
export { DataUploadsComponent } from './admin/data-uploads/data-uploads.component';
...
export { ClasstimetableComponent } from './timetable/classtimetable/classtimetable.component';
